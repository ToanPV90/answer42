package com.samjdtechnologies.answer42.service.helper;
...
public class AIInteractionHelper {
     ...
     */
    public List<Message> convertToAIMessages(List<com.samjdtechnologies.answer42.model.ChatMessage> messages, 
                                          String systemPrompt) {
        ...
        for (com.samjdtechnologies.answer42.model.ChatMessage message : messages) {
