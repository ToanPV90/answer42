 ...
 */
public class AuthorEntry extends HorizontalLayout {
    private static final Logger LOG = LoggerFactory.getLogger(AuthorEntry.class);
     ...
     */
    public AuthorEntry(VerticalLayout parent, Runnable formValidator) {
        this.parent = parent;
